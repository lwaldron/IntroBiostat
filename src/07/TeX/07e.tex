...
\begin{center}
\includegraphics[width=0.42\textwidth]{07/figures/eoce/resDemo1/resDemoLin.pdf} 
\includegraphics[width=0.42\textwidth]{07/figures/eoce/resDemo1/resDemoFanBack.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.42\textwidth]{07/figures/eoce/resDemo2/resDemoResScatFan.pdf} 
\includegraphics[width=0.42\textwidth]{07/figures/eoce/resDemo2/resDemoResScatExp.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association1.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association2.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association3.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association4.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association5.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association6.pdf}
\end{center}
}{}
...
\eoce{\qt{Identify relationships, Part I} For each of the six plots, identify the strength of the relationship (e.g. weak, moderate, or strong) in the data and whether fitting a linear model would be reasonable.
\begin{center}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association7.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association8.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association9.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association10.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association11.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/association/association12.pdf}
\end{center}
}{}

% 5

\eoce{The two scatterplots below show the relationship between final and mid-semester exam grades recorded during several years for a Statistics course at a university.
\begin{parts}
...
\end{parts}
\begin{center}
\includegraphics[width=0.49\textwidth]{07/figures/eoce/exam/final_exam1.pdf}\ \ 
\includegraphics[width=0.49\textwidth]{07/figures/eoce/exam/final_exam2.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{07/figures/eoce/husbandsWives/husbandsWives_age} \hspace{5mm}
\includegraphics[width=0.4\textwidth]{07/figures/eoce/husbandsWives/husbandsWives_height}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.485\textwidth]{07/figures/eoce/speed/speed_height}\hspace{0.02\textwidth}%
\includegraphics[width=0.485\textwidth]{07/figures/eoce/speed/speed_height_gender}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.485\textwidth]{07/figures/eoce/trees/height_vol}\hspace{0.02\textwidth}%
\includegraphics[width=0.485\textwidth]{07/figures/eoce/trees/girth_vol}
\end{center}
\begin{parts}
...
\includegraphics[width=\textwidth]{07/figures/eoce/coastStarlight/coastStarScat}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{07/figures/eoce/babiesCrawl/babiesCrawl}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{07/figures/eoce/bodyMeas/bodyHgtShoGi}
\end{minipage}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.52\textwidth}
\includegraphics[width=\textwidth]{07/figures/eoce/bodyMeas/bodyWgtHipGi}
\end{minipage}
}{}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width= \textwidth]{07/figures/eoce/gradesTV/gradesTV} \\
\end{center}
\end{minipage} \\[4mm]
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width= \textwidth]{07/figures/eoce/starbucks/pro_cals} \\
\end{center}
\end{minipage}
...
\begin{center}
\includegraphics[width= \textwidth]{07/figures/eoce/helmet/lunch_helmet} \\
\end{center}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/outliers/outInf1.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/outliers/outLev1.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/outliers/outOut1.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/outliers/outInf2.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/outliers/outInf3.pdf}
\includegraphics[width=0.32\textwidth]{07/figures/eoce/outliers/outOut2.pdf}
\end{center}
}{}
...
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
\includegraphics[width=0.95\textwidth]{07/figures/eoce/urbanOwner/urbanOwner_withDC.pdf} \vspace{-3mm}
\end{minipage}
}{}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=57mm]{07/figures/eoce/bac/bloodAlc.pdf}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{07/figures/eoce/bodyMeas/bodyWgtHgt}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{07/figures/eoce/husbandsWives/husbandsWives_age}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\begin{center}
\includegraphics[width=\textwidth]{07/figures/eoce/husbandsWives/husbandsWives_height}
\end{center}
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
{\scriptsize
...
\begin{center}
\includegraphics[width=\textwidth]{07/figures/eoce/urbanOwner/urbanOwner_withoutDC}
\end{center}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{07/figures/eoce/prof/beauty_eval} \\
\end{center}
\end{minipage}
