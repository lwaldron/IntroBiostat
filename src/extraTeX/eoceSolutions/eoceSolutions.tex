...
(b) Same IQR, but second distribution has higher median.
...
% 39
\eocesol{(a)~$H_0$: The mean MET for each group is equal to the others. $H_A$: At least one pair of means is different.
...
(b)~$b_1 = -0.537$. $b_0 = 55.34$.
(c)~For a neighborhood with 0\% reduced-fee lunch, we would expect 55.34\% of the bike riders to wear helmets.
(d)~For every additional percentage point of reduced fee lunches in a neighborhood, we would expect 0.537\% fewer kids to be wearing helmets.
